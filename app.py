    ...
    if request.method == 'POST':
        ...
        if 'Please Select' not in PlayerList and len(set(PlayerList)) == 11:
            ...
            if Squad != 0:
                ...
                return render_template("Dashboard2.html", Squad=Squad, Squad_Position=Squad_Position,
                                       Squad_Team=Squad_Team,
                                       Squad_xPoints=Squad_xPoints, ExcludePlayers=ExcludePlayers,
                                       ExcludeTeam=ExcludeTeam,
                                       Squad_Captain=Squad_Captain, Budget=Budget, TransferCost=TransferCost,
                                       nShare=nShare, Expected_points=Expected_points, buy_list=buy_list,
                                       sell_list=sell_list,
                                       buy_list_position=buy_list_position, buy_list_team=buy_list_team,
                                       buy_list_xPoints=buy_list_xPoints,
                                       sell_list_team=sell_list_team, sell_list_position=sell_list_position,
                                       sell_list_xPoints=sell_list_xPoints,
                                       form=form)
            else:
                ...
                TransferCost = 0
                Expected_points = 0
                return render_template('fail.html', name=current_user.username, Squad=Squad,
                                       Squad_Position=Squad_Position, Squad_Team=Squad_Team,
                                       Squad_xPoints=Squad_xPoints, Squad_Captain=Squad_Captain, labels=labels,
                                       values=values,
            ...
            TransferCost = 0
            Expected_points = 0
            return render_template('fail.html', name=current_user.username, Squad=Squad, Squad_Position=Squad_Position,
                                   Squad_Team=Squad_Team,
                                   Squad_xPoints=Squad_xPoints, Squad_Captain=Squad_Captain, labels=labels,
                                   values=values,
                                   nShare=nShare, Budget=Budget, error_statement=error_statement)
...
def dashboard():
    ...
    if found_user.Player11 != '':
        ...
        Squad, Squad_Team, Squad_xPoints, Squad_Position, Squad_Captain, Budget, TransferCost, nShare, Expected_points, buy_list, sell_list, buy_list_position, buy_list_team, buy_list_xPoints, sell_list_team, sell_list_position, sell_list_xPoints = Pulp_optimization(
            Teams, N, Data, Value, Squad, xPointsTotal,
    ...
    return render_template('dashboard.html', name=current_user.username, Squad=Squad, Squad_Position=Squad_Position,
                           Squad_Team=Squad_Team,
...
def top100():
    ...
    if found_user.Player1 != '':
        ...
        Transfer = list(
            np.where(np.isin(list(Data['Name']), Squad), 0, np.array(Value) * 0.01))  # Value*0,01 if on team
    else:
    ...
    return render_template('top100.html', TotPoints=TotPoints, Name=Name, Team1=Team1, xPoints1=xPoints1,
                           Transfer1=Transfer1,
...
def top100growth():
    ...
    if found_user.Player1 != '':
        ...
        Squad, Squad_Team, Squad_xPoints, Squad_Position, Squad_Captain, Budget, TransferCost, nShare, Expected_points, sell_list, buy_list, buy_list_position, buy_list_team, buy_list_xPoints, sell_list_team, sell_list_position, sell_list_xPoints = Pulp_optimization(
            Teams, N, Data, Value, Squad, xPointsTotal,
            Positions, [], Squad, [], 0, Budget, Names, xPoints)
    ...
    return render_template('top100growth.html', TotPoints=TotPoints, Name=Name, Team1=Team1, xPoints1=xPoints1,
                           Transfer1=Transfer1,
                           xPointsTotal1=xPointsTotal1, TotalPoints1=TotalPoints1, xGrowth1=xGrowth1)
...
def AnalyzePlayers():
    ...
    values1 = [xPoints[Player1_index], xPoints2[Player1_index] / discount, xPoints3[Player1_index] / discount ** 2,
               xPoints4[Player1_index] / discount ** 3, xPoints5[Player1_index] / discount ** 4,
               xPoints6[Player1_index] / discount ** 5]

    values2 = [xPoints[Player2_index], xPoints2[Player2_index] / discount, xPoints3[Player2_index] / discount ** 2,
               xPoints4[Player2_index] / discount ** 3, xPoints5[Player2_index] / discount ** 4,
               xPoints6[Player2_index] / discount ** 5]
