...
def ExpectedCS():
    ...
    col1 = list(round(Data_ECS['xCS'],2))
    col2 = list(round(Data_ECS['xCS2'],2))
    col3 = list(round(Data_ECS['xCS3'],2))
...
def ExpectedG():
    ...
    col1 = list(round(Data_EG['xG adj.fac. 1'],2))
    col2 = list(round(Data_EG['xG adj.fac. 2'],2))
    col3 = list(round(Data_EG['xG adj.fac. 3'],2))
...
def ExpectedW():
    ...
    col4 = list(round(Data_EW['1/8 Finals'],2))
    col5 = list(round(Data_EW['Win all'],2))
